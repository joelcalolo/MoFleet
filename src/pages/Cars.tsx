    ...
    <Layout>
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 sm:mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold mb-2">Gestão de Carros</h1>
            <p className="text-sm sm:text-base text-muted-foreground">Cadastre e gerencie a frota de veículos</p>
          </div>
